...
These two parameters were added in Consent Mode v2. If you implemented Consent Mode before mid-2023, your implementation is missing them. Google started enforcing v2 requirements for EEA ad serving in early 2024. Check that both are in your defaults and your update calls.
