...
The GA4 Configuration Tag — now officially called the **Google Tag** — is the foundation of your GA4 implementation. It loads the Google Analytics library, establishes the connection to your GA4 property, and optionally sends a page view hit. Every other GA4 Event tag in your container depends on it.
