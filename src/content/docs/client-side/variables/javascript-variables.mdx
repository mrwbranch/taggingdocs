...
<Aside type="tip">
If you're not comfortable with JavaScript as a language — closures, optional chaining, array methods, promises — read [JavaScript for Tag Managers](/resources/javascript-for-tag-managers/) first. This page assumes that foundation and focuses on the Custom JavaScript Variable patterns built on top.
</Aside>
