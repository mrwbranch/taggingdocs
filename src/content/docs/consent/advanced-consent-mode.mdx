...
1. Set default consent state to `denied` before GTM loads (see [Consent Mode GTM Setup](/consent/consent-mode-gtm-setup/))
...
To implement Basic mode instead, see [Basic Consent Mode](/consent/basic-consent-mode/).
...
<CardGrid>
  <LinkCard title="Basic Consent Mode" href="/consent/basic-consent-mode/" description="When to use Basic mode and how it differs from Advanced." />
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode-gtm-setup/" description="Step-by-step configuration for implementing either mode correctly." />
  <LinkCard title="Testing Consent" href="/consent/testing-consent/" description="How to verify pings are firing correctly in denied consent state." />
</CardGrid>
