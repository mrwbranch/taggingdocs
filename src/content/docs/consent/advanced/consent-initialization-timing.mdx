...
<CardGrid>
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode/consent-mode-gtm-setup/" description="Complete configuration guide including trigger setup and the wait_for_update parameter." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="How to verify consent state timing using GTM Preview mode's Consent tab." />
  <LinkCard title="CMP Integration" href="/consent/cmp-integration/cmp-integration/" description="Ensuring your CMP callback fires early enough to meet the wait_for_update window." />
</CardGrid>
