...
<CardGrid>
  <LinkCard title="Consent State via DataLayer" href="/consent/cmp-integration/consent-state-datalayer/" description="How to push and read consent state in the browser dataLayer." />
  <LinkCard title="Consent Mode v2 Explained" href="/consent/consent-mode/consent-mode-v2/" description="The full consent signal model and what each type controls." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="Testing the complete consent flow including server-side verification." />
</CardGrid>
