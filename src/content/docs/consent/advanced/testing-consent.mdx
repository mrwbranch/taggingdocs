...
<CardGrid>
  <LinkCard title="Consent Mode v2 Explained" href="/consent/consent-mode/consent-mode-v2/" description="What the gcs parameter values mean and what data is sent in each state." />
  <LinkCard title="Advanced Consent Mode" href="/consent/consent-mode/advanced-consent-mode/" description="Understanding what cookieless pings look like in the network tab." />
  <LinkCard title="CMP Integration" href="/consent/cmp-integration/cmp-integration/" description="CMP-specific troubleshooting for when the consent update is not firing." />
</CardGrid>
