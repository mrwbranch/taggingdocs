...
<CardGrid>
  <LinkCard title="Consent Mode v2 Explained" href="/consent/consent-mode/consent-mode-v2/" description="The seven consent types and why the default state must come before GTM." />
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode/consent-mode-gtm-setup/" description="Triggers, tags, and consent settings configuration in GTM." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="A complete testing protocol including network verification and Preview mode checks." />
</CardGrid>
