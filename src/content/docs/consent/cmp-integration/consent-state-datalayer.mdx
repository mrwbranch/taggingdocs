...
<CardGrid>
  <LinkCard title="Consent for Non-Google Tags" href="/consent/cmp-integration/consent-non-google-tags/" description="Blocking non-Google tags like Meta Pixel and LinkedIn based on consent state." />
  <LinkCard title="Consent Initialization Timing" href="/consent/advanced/consent-initialization-timing/" description="The trigger order that determines when consent state is available to tags." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="How to verify consent state is read and applied correctly." />
</CardGrid>
