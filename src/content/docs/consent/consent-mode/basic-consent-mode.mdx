...
Add the consent state as a trigger condition on all tracking-related triggers. Using the dataLayer consent state pattern from [Consent State via DataLayer](/consent/cmp-integration/consent-state-datalayer/):
...
<CardGrid>
  <LinkCard title="Advanced Consent Mode" href="/consent/consent-mode/advanced-consent-mode/" description="How cookieless pings work and the privacy tradeoffs of Advanced mode." />
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode/consent-mode-gtm-setup/" description="Complete configuration guide including tag consent settings." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="Verify that Basic mode correctly suppresses all data before consent." />
</CardGrid>
