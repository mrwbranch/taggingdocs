...
<Aside type="tip">
If you haven't read [Consent Mode v2 Explained](/consent/consent-mode/consent-mode-v2/) yet, do that first. This article assumes you understand what the seven consent types control and why the default-before-GTM requirement exists.
</Aside>
...
Most major CMPs provide a Community Template Gallery integration that handles the consent update automatically. See [CMP Integration](/consent/cmp-integration/cmp-integration/) for CMP-specific setup instructions.
...
- Meta Pixel, LinkedIn, TikTok: use the blocking approach in [Consent for Non-Google Tags](/consent/cmp-integration/consent-non-google-tags/)
...
<CardGrid>
  <LinkCard title="Consent Mode v2 Explained" href="/consent/consent-mode/consent-mode-v2/" description="What the seven consent types control and the full regulatory context." />
  <LinkCard title="CMP Integration" href="/consent/cmp-integration/cmp-integration/" description="CMP-specific integration guides for Cookiebot, OneTrust, Usercentrics, and others." />
  <LinkCard title="Consent Initialization Timing" href="/consent/advanced/consent-initialization-timing/" description="The trigger order that makes or breaks consent implementation correctness." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="A complete testing protocol for your consent implementation." />
</CardGrid>
