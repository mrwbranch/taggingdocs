...
<CardGrid>
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode/consent-mode-gtm-setup/" description="Step-by-step configuration in GTM including trigger setup and tag consent settings." />
  <LinkCard title="Advanced Consent Mode" href="/consent/consent-mode/advanced-consent-mode/" description="How cookieless pings work and when to use Advanced vs. Basic mode." />
  <LinkCard title="CMP Integration" href="/consent/cmp-integration/cmp-integration/" description="Connecting your consent banner platform to GTM's Consent Mode." />
  <LinkCard title="Testing Consent" href="/consent/advanced/testing-consent/" description="Verifying your consent implementation works correctly end-to-end." />
</CardGrid>
