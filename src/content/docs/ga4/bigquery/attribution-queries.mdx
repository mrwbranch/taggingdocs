...
description: "Implement first-touch, last-touch, linear, time-decay, and position-based attribution models in BigQuery SQL using GA4 event data."
---

import { Aside, CardGrid, LinkCard } from '@astrojs/starlight/components';

Attribution analysis in BigQuery gives you full control over the model, lookback window, and conversion definition. Unlike GA4's built-in attribution (which is session-scoped and uses last non-direct click in standard reports), BigQuery attribution can span the full user lifetime and credit any event or channel you define.
