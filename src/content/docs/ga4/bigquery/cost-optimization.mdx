...
**On-demand pricing**: You pay per byte scanned by your queries, currently approximately $5 per TB. There is no charge for storage beyond the first 10 GB/month free tier, then $0.02/GB/month for active storage and $0.01/GB/month for long-term (data not modified in 90 days).
