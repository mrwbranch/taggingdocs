...
<Aside type="tip">
Google AI Overview clicks appear as regular Organic Search in GA4 — there is no referrer or parameter to distinguish them. The custom channel above only catches traffic from standalone AI chat tools, not from Google's AI features in search results. See [Tracking AI Overview & AI Chat Traffic](/recipes/reference/track-ai-overview-traffic/) for a complete guide including a GTM-based detection method.
</Aside>
...
<CardGrid>
  ...
  />
  <LinkCard
    title="Tracking AI Overview & AI Chat Traffic"
    description="Complete guide to identifying and measuring AI-referred traffic in GA4."
    href="/recipes/reference/track-ai-overview-traffic/"
  />
</CardGrid>
