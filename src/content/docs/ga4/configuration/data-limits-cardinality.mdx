...
- Standard GA4: `page_location` (1,000 chars), `page_title` (300 chars), `page_referrer` (420 chars)
- GA4 360: Parameter string values up to 500 characters, except `page_location` (1,000 chars), `page_title` (300 chars), `page_referrer` (420 chars)
