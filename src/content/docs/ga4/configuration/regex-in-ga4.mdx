...
<CardGrid>
  ...
  <LinkCard title="GTM Trigger Types" href="/client-side/triggers/trigger-types-overview/" description="How regex works in GTM triggers (case-sensitive by default)" />
</CardGrid>
