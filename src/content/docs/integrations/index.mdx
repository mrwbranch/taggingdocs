...
<Aside type="tip">
New to the ad-tech landscape? Read [How Programmatic Advertising Works](/integrations/how-programmatic-advertising-works/) first. It explains DSPs, SSPs, RTB, walled gardens, and the rest of the acronyms the per-platform pages use. Ten-minute read, saves confusion later.
</Aside>
