...
<CardGrid>
  ...
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode/consent-mode-gtm-setup/" description="The correct inline consent default pattern that avoids dual deployment." />
</CardGrid>
