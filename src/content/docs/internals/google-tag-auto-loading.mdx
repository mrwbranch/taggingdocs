...
<CardGrid>
  ...
  <LinkCard title="Consent Mode GTM Setup" href="/consent/consent-mode/consent-mode-gtm-setup/" description="How the shared Google Tag instance simplifies consent configuration." />
