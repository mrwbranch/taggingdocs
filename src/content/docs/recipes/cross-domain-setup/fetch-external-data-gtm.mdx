...
<CardGrid>
  <LinkCard title="Server-Side Shopify Tracking" href="/recipes/ecommerce-conversions/server-side-shopify-tracking/" description="Move enrichment logic to server-side GTM for better security and performance." />
  <LinkCard title="User-ID Implementation" href="/recipes/testing/user-id-implementation/" description="The authentication foundation that makes CRM enrichment possible." />
</CardGrid>
