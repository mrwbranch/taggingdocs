...
<CardGrid>
  <LinkCard title="Cross-Domain Tracking Setup" href="/recipes/cross-domain-setup/cross-domain-setup/" description="When users travel between entirely separate domains." />
  <LinkCard title="iFrame Tracking" href="/recipes/cross-domain-setup/iframe-tracking/" description="When a subdomain is embedded as an iframe on the main domain." />
</CardGrid>
