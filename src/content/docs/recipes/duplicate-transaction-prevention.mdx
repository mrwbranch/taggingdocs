...
<CardGrid>
  <LinkCard title="Track Form Submissions" href="/recipes/track-form-submissions/" description="The same AJAX success callback pattern for lead gen forms." />
  <LinkCard title="Offline Conversion Import" href="/recipes/offline-conversion-import/" description="Server-side conversion tracking for long sales cycles." />
</CardGrid>
