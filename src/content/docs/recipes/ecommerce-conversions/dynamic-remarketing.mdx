...
<CardGrid>
  <LinkCard title="Enhanced Conversions Setup" href="/recipes/ecommerce-conversions/enhanced-conversions-setup/" description="Add hashed user data to Google Ads conversion tags." />
  <LinkCard title="Consent Mode with Cookiebot" href="/recipes/privacy-consent/google-consent-mode-cookiebot/" description="Ensure remarketing respects consent correctly." />
</CardGrid>
