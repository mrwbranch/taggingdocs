...
<CardGrid>
  <LinkCard title="Enhanced Conversions" href="/recipes/ecommerce-conversions/enhanced-conversions/" description="Improve online conversion matching with hashed user data." />
  <LinkCard title="User-ID Implementation" href="/recipes/testing/user-id-implementation/" description="Cross-device attribution via consistent user identification." />
</CardGrid>
