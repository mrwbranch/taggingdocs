...
<CardGrid>
  <LinkCard title="Duplicate Transaction Prevention" href="/recipes/ecommerce-conversions/duplicate-transaction-prevention/" description="Client-side deduplication guard for purchase events." />
  <LinkCard title="Enhanced Conversions Setup" href="/recipes/ecommerce-conversions/enhanced-conversions-setup/" description="Add hashed user data to Google Ads through sGTM." />
</CardGrid>
