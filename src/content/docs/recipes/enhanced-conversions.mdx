...
<CardGrid>
  <LinkCard title="Enhanced Conversions Setup" href="/recipes/enhanced-conversions-setup/" description="Complete walkthrough including Google Ads account configuration." />
  <LinkCard title="Offline Conversion Import" href="/recipes/offline-conversion-import/" description="Capture conversions that happen offline after the ad click." />
</CardGrid>
