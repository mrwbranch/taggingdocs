...
<CardGrid>
  <LinkCard title="Consent Mode with Cookiebot" href="/recipes/google-consent-mode-cookiebot/" description="The same process for Cookiebot users." />
  <LinkCard title="PII Detection & Removal" href="/recipes/pii-detection-removal/" description="Additional privacy safeguards beyond consent signals." />
</CardGrid>
