...
<CardGrid>
  <LinkCard title="Track Internal Search" href="/recipes/interaction-tracking/track-internal-search/" description="Another zero-code-required event with URL parameter reading." />
  <LinkCard title="PII Detection & Removal" href="/recipes/privacy-consent/pii-detection-removal/" description="Strip sensitive data from URLs before they reach GA4." />
</CardGrid>
