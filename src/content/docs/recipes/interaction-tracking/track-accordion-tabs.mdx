...
<CardGrid>
  <LinkCard title="Track Button Clicks" href="/recipes/interaction-tracking/track-button-clicks/" description="The foundational pattern that accordion and tab tracking builds on." />
  <LinkCard title="Track Anchor Clicks" href="/recipes/interaction-tracking/track-anchor-clicks/" description="Same-page navigation tracking for long-form content." />
</CardGrid>
