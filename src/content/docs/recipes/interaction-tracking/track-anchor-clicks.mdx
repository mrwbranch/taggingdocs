...
<CardGrid>
  <LinkCard title="Track Accordion & Tabs" href="/recipes/interaction-tracking/track-accordion-tabs/" description="Tracking expand/collapse interactions in content components." />
  <LinkCard title="Track Scroll Milestones" href="/recipes/interaction-tracking/track-scroll-milestones/" description="Complement anchor navigation with scroll depth data." />
</CardGrid>
