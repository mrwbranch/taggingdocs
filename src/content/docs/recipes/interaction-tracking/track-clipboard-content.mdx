...
<CardGrid>
  <LinkCard title="Track Copy & Paste" href="/recipes/interaction-tracking/track-copy-paste/" description="Simpler version tracking just that a copy happened, not what." />
  <LinkCard title="PII Detection & Removal" href="/recipes/privacy-consent/pii-detection-removal/" description="Additional safeguards for stripping sensitive content." />
</CardGrid>
