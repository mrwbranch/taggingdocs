...
<CardGrid>
  <LinkCard title="Track Infinite Scroll" href="/recipes/interaction-tracking/track-infinite-scroll/" description="Applying element visibility to dynamically loaded feed content." />
  <LinkCard title="Track Scroll Milestones" href="/recipes/interaction-tracking/track-scroll-milestones/" description="Page-level scroll tracking as a complement to element visibility." />
</CardGrid>
