...
**Mobile detection is a superset of tab visibility.** If you also use the [Track Tab Visibility](/recipes/interaction-tracking/track-tab-visibility/) recipe, the `visibilitychange` handler in this recipe will overlap. Separate the two concerns or add a guard to check which recipe should fire based on time thresholds.

<CardGrid>
  <LinkCard title="Track Tab Visibility" href="/recipes/interaction-tracking/track-tab-visibility/" description="More detailed visibility tracking with timing data." />
  <LinkCard title="Track Scroll Milestones" href="/recipes/interaction-tracking/track-scroll-milestones/" description="Context for interpreting scroll depth at exit." />
</CardGrid>
