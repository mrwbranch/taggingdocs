...
**Form embedded in iframe.** If the form is in a cross-origin iframe, you cannot access it directly. Use the iframe's `postMessage` callback. See the [iFrame Tracking recipe](/recipes/cross-domain-setup/iframe-tracking/).
...
<CardGrid>
  <LinkCard title="Track Button Clicks" href="/recipes/interaction-tracking/track-button-clicks/" description="The same three-approach pattern applied to button interactions." />
  <LinkCard title="iFrame Tracking" href="/recipes/cross-domain-setup/iframe-tracking/" description="Track events inside embedded forms and iframes." />
  <LinkCard title="Duplicate Transaction Prevention" href="/recipes/ecommerce-conversions/duplicate-transaction-prevention/" description="Guard against double-counting conversions." />
</CardGrid>
