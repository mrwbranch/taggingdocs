...
<CardGrid>
  <LinkCard title="Track Element Visibility" href="/recipes/interaction-tracking/track-element-visibility/" description="Element visibility tracking for static pages." />
  <LinkCard title="Track Scroll Milestones" href="/recipes/interaction-tracking/track-scroll-milestones/" description="Page-level depth tracking for traditional layouts." />
</CardGrid>
