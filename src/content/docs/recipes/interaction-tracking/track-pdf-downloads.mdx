...
<CardGrid>
  <LinkCard title="Track Button Clicks" href="/recipes/interaction-tracking/track-button-clicks/" description="The same CSS selector and dataLayer patterns for button interactions." />
  <LinkCard title="GTM Regex Cheatsheet" href="/recipes/reference/regex-cheatsheet/" description="File extension patterns and URL matching reference." />
</CardGrid>
