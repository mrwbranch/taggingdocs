...
<CardGrid>
  <LinkCard title="Track Button Clicks" href="/recipes/interaction-tracking/track-button-clicks/" description="Standard button click tracking for non-frustrated interactions." />
  <LinkCard title="PII Detection & Removal" href="/recipes/privacy-consent/pii-detection-removal/" description="Ensure element_text does not contain user-entered data." />
</CardGrid>
