...
<CardGrid>
  <LinkCard title="Track Video Engagement" href="/recipes/interaction-tracking/track-video-engagement/" description="The same milestone approach applied to video progress." />
  <LinkCard title="Track Infinite Scroll" href="/recipes/interaction-tracking/track-infinite-scroll/" description="Tracking content consumption in feed-style layouts." />
</CardGrid>
