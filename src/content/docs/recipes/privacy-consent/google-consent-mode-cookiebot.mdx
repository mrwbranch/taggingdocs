...
<CardGrid>
  <LinkCard title="Consent Mode with CookieYes" href="/recipes/privacy-consent/google-consent-mode-cookieyes/" description="The same process for CookieYes users." />
  <LinkCard title="PII Detection & Removal" href="/recipes/privacy-consent/pii-detection-removal/" description="Additional privacy safeguards beyond consent mode." />
</CardGrid>
