...
<CardGrid>
  <LinkCard title="GTM Regex Cheatsheet" href="/recipes/reference/regex-cheatsheet/" description="PII detection patterns and URL matching reference." />
  <LinkCard title="Track Internal Search" href="/recipes/interaction-tracking/track-internal-search/" description="Search tracking implementation where PII scrubbing is particularly important." />
</CardGrid>
