...
<Aside type="note">
This recipe covers the `copy` event (Ctrl+C). See [Track Clipboard Content](/recipes/track-clipboard-content/) for a more detailed recipe that captures what was copied.
</Aside>
...
<CardGrid>
  <LinkCard title="Track Clipboard Content" href="/recipes/track-clipboard-content/" description="More detailed clipboard tracking including what was copied." />
  <LinkCard title="PII Detection & Removal" href="/recipes/pii-detection-removal/" description="Strip sensitive content before it reaches GA4." />
</CardGrid>
