...
<CardGrid>
  <LinkCard title="Track PDF Downloads" href="/recipes/track-pdf-downloads/" description="Track when users download a printable PDF version." />
  <LinkCard title="Track Tab Visibility" href="/recipes/track-tab-visibility/" description="Another indirect engagement signal using browser events." />
</CardGrid>
