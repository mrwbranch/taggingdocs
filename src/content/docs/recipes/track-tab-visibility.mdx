...
<CardGrid>
  <LinkCard title="Track Exit Intent" href="/recipes/track-exit-intent/" description="Detect when users are about to leave the page entirely." />
  <LinkCard title="Track Scroll Milestones" href="/recipes/track-scroll-milestones/" description="Combine with scroll depth for a complete engagement picture." />
</CardGrid>
