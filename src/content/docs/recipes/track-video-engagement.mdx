...
<CardGrid>
  <LinkCard title="Track Scroll Milestones" href="/recipes/track-scroll-milestones/" description="The same milestone-tracking pattern applied to scroll depth." />
  <LinkCard title="Single-Page App Tracking" href="/recipes/single-page-app-tracking/" description="How to handle dynamically loaded content in SPAs." />
</CardGrid>
