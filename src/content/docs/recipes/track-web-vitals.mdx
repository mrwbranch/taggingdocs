...
<CardGrid>
  <LinkCard title="Fetch External Data in GTM" href="/recipes/fetch-external-data-gtm/" description="Another async pattern for enriching events with external data." />
  <LinkCard title="Track Scroll Milestones" href="/recipes/track-scroll-milestones/" description="Engagement metrics to correlate with performance scores." />
</CardGrid>
