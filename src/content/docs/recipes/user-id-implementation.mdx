...
<CardGrid>
  <LinkCard title="A/B Test Tracking" href="/recipes/ab-test-tracking/" description="Combine User-ID with experiment variant tracking for accurate results." />
  <LinkCard title="Cross-Domain Tracking Setup" href="/recipes/cross-domain-setup/" description="User-ID complements cross-domain tracking for multi-site journeys." />
</CardGrid>
