...
<Aside type="tip" title="Prefer to let an AI drive this?">
If you'd rather ask Claude or ChatGPT to do your GTM automation, the [TaggingDocs MCP Server](/mcp/) exposes the same GTM API through natural language — no code required.
</Aside>
