...
Document your naming rules here so everyone follows the same pattern. For a comprehensive guide on naming standards, see the [Naming Conventions Checklist](/resources/naming-conventions-checklist/).
...
For detailed guidance on naming, standardization across teams, and naming governance, see [Naming Conventions Checklist](/resources/naming-conventions-checklist/).
...
|-----|--------|---|---|
| **Daily event volume stability** | ±10% vs. 7-day average | Data Studio dashboard checking yesterday vs. weekly baseline | > 15% drop |
