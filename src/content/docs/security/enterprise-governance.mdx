...
<CardGrid>
  ...
  />
  <LinkCard
    title="Enterprise GTM for Multi-Brand Organizations"
    description="Governance patterns for 50+ containers across multiple brands and business units."
    href="/security/enterprise-gtm-governance/"
  />
</CardGrid>
