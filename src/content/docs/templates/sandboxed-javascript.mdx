...
<Aside type="tip">
The sandbox restricts the available JavaScript APIs, but the JavaScript *language* is the same — closures, array methods, promises, destructuring all work. If you're new to the language itself, read [JavaScript for Tag Managers](/resources/javascript-for-tag-managers/) first; this page assumes that foundation and focuses on what's different about the sandbox.
</Aside>
